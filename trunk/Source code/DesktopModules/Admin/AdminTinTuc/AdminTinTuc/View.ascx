<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="View.ascx.cs" Inherits="IDG.Dnn.AdminTinTuc.View" %>
<fieldset class="fieldset">
    ...
    <table width="100%">
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList runat="server" ID="ddlLoaiTin">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <asp:ListItem Text="--Tất cả--" Value="-1"></asp:ListItem>
                    ...
                    <asp:ListItem Text="IDG" Value="1"></asp:ListItem>
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
...
<asp:GridView CssClass="gridview" runat="server" OnRowCommand="gvAdminLoaiTin_RowCommand"
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText=" Ngày tạo" HeaderStyle-Width="10%">
            <ItemTemplate>
                <%#Eval("NgayTao") %>
            </ItemTemplate>
            <ItemStyle HorizontalAlign="Center" />
        </asp:TemplateField>
        <asp:TemplateField HeaderText=" Nổi bật" HeaderStyle-Width="10%">
            <ItemTemplate>
                <%#Eval("NoiBat") %>
            </ItemTemplate>
            <ItemStyle HorizontalAlign="Center" />
        ...
        <asp:TemplateField HeaderText="Xóa" HeaderStyle-Width="5%">
            <ItemTemplate>
                <asp:ImageButton ID="ibtn" OnClientClick="javascript:return confirm('Bạn thực sự muốn xóa Loại tin đã chọn?');"
                    CommandName="DeleteTinTuc" CommandArgument='<%# Eval("ID") %>'
