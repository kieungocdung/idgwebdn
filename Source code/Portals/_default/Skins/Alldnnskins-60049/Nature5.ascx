...
<link href="<%= SkinPath %>Nature5.css" rel="stylesheet" type="text/css" />
<table width="80%" border="0" cellspacing="0" cellpadding="0" height="95%" align="center">
  <tr>
    <td align="left" valign="top" height="108"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" background="<%= SkinPath %>images/5topmiddle.jpg" style="background-repeat:repeat-x; background-position:left top">
      <tr>
 <td align="left" valign="top" height="108"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" background="<%= SkinPath %>images/5topmiddle.jpg" style="background-repeat:repeat-x; background-position:left top">
      <tr>
        <td width="25" align="left" valign="top"><img src="<%= SkinPath %>images/5topleft.jpg" width="25" height="108"></td>
        <td align="left" valign="middle" style="padding-top:15px; padding-left:10px"><dnn:LOGO runat="server" id="dnnLOGO" /></td>
        <td width="297" align="left" valign="top" style="text-align:right"><img src="<%= SkinPath %>images/abc.png" height="108"></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td height="53" align="left" valign="top" background="<%= SkinPath %>images/4melomiddle.jpg" style="background-repeat:repeat-x; background-position:left top"><table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
      <tr>
        <td width="23" align="left" valign="top"><img src="<%= SkinPath %>images/5meloleft.jpg" width="23" height="53"></td>
          ...
          <tr>
            <td align="center" valign="middle" height="23"><table width="60%" border="0" cellspacing="0" cellpadding="0" height="23"  background="<%= SkinPath %>images/menumiddle.jpg" style="background-repeat:repeat-x; background-position:left top">
              <tr>
                ...
                <td align="left" valign="middle" style="padding-left:10px"><dnn:SOLPARTMENU runat="server" id="dnnSOLPARTMENU" rightseparatoractive="<img src=&quot;images/5menubgright.jpg&quot; >" leftseparatoractive="<img src=&quot;images/5menubgleft.jpg&quot; >" rightseparatorbreadcrumb="<img src=&quot;images/5menubgright.jpg&quot;>" leftseparatorbreadcrumb="<img src=&quot;images/5menubgleft.jpg&quot; >" usearrows="false" userootbreadcrumbarrow="false" rootmenuitemcssclass="MainMenu_TabRootMenuItem" rootmenuitembreadcrumbcssclass="MainMenu_TabRootMenuItemSel" rootmenuitemselectedcssclass="MainMenu_TabMenuItemHover" Rootmenuitemactivecssclass="MainMenu_TabMenuItemSelHover" menuitemselcssclass="MainMenu_MenuItemSel" submenucssclass="submenu" submenuitemselectedcssclass="submenuitemselected" submenuitembreadcrumbcssclass="submenuitembreadcrumb" /></td>
        ...
        <td width="24" align="left" valign="top"><img src="<%= SkinPath %>images/5meloright.jpg" width="24" height="53"></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td align="left" valign="top" height="100%"><table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
      <tr>
        <td width="16" align="left" valign="top" background="<%= SkinPath %>images/5pleft.jpg" style="background-repeat:repeat-y; background-position:left top"></td>
        ...
        <td width="18" align="right" valign="top" background="<%= SkinPath %>images/5pright.jpg" style="background-repeat:repeat-y; background-position:left top"></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td height="72" align="left" valign="top" background="<%= SkinPath %>images/5bottommiddle.jpg" style="background-repeat:repeat-x; background-position:left top"><table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
      <tr>

        <td width="23" align="left" valign="top"><img src="<%= SkinPath %>images/5bottomleft.jpg" width="23" height="72" /></td>
        ...
        <td width="25" align="right" valign="top"><img src="<%= SkinPath %>images/5bottomright.jpg" width="25" height="72" /></td>
      </tr>
    </table></td>
  </tr>
</table>
